...
@pytest.mark.parametrize(
    'world, model_download_source, model_store, interactive, overwrite, dryrun',
    [
...
def test_model_exist_default(
    world, interactive, model_download_source, model_store, overwrite, dryrun
):
    """
...
def test_model_not_exist_default(
    world, interactive, model_download_source, model_store, overwrite, dryrun
):
    """
    Test model generation
...
def test_model_not_exist_custom(
    world, interactive, model_download_source, model_store, overwrite, dryrun
):
    """
    Test model generation
